    ...
    func makeStandartState() {
        ...
        viewState.rows.append(ViewState.Calendar(image: UIImage(), title: "Calendar", items: [
            CalendarItemCollectionCell.ViewState(upColor: UIColor(red: 1, green: 0.874, blue: 0.426, alpha: 1),
                                                 downColor: UIColor(red: 1, green: 0.426, blue: 0.495, alpha: 1), image: UIImage(), title: "HairCut", isLocked: false),
            CalendarItemCollectionCell.ViewState(upColor: UIColor(red: 0.472, green: 0.873, blue: 1, alpha: 1),
                                                 downColor: UIColor(red: 0.56, green: 0.522, blue: 1, alpha: 1), image: UIImage(), title: "Beginning", isLocked: true),
            CalendarItemCollectionCell.ViewState(upColor: UIColor(red: 1, green: 0.676, blue: 0.87, alpha: 1),
                                                 downColor: UIColor(red: 1, green: 0.426, blue: 0.874, alpha: 1), image: UIImage(), title: "Сreativity", isLocked: true),
            CalendarItemCollectionCell.ViewState(upColor: UIColor(red: 0.529, green: 0.967, blue: 0.914, alpha: 1),
                                                 downColor: UIColor(red: 0.327, green: 0.803, blue: 0.834, alpha: 1), image: UIImage(), title: "Housework", isLocked: true),
            CalendarItemCollectionCell.ViewState(upColor: UIColor(red: 0.41, green: 0.971, blue: 0.803, alpha: 1),
                                                 downColor: UIColor(red: 0, green: 0.671, blue: 0.429, alpha: 1), image: UIImage(), title: "Garden", isLocked: true),
            CalendarItemCollectionCell.ViewState(upColor: UIColor(red: 1, green: 0.605, blue: 0.605, alpha: 1),
                                                 downColor: UIColor(red: 1, green: 0.309, blue: 0.641, alpha: 1), image: UIImage(), title: "Cash transactions", isLocked: true),
            CalendarItemCollectionCell.ViewState(upColor: UIColor(red: 0.904, green: 0.747, blue: 1, alpha: 1),
                                                 downColor: UIColor(red: 0.776, green: 0.409, blue: 1, alpha: 1), image: UIImage(), title: "Cash transactions", isLocked: true),
            CalendarItemCollectionCell.ViewState(upColor: UIColor(red: 1, green: 0.907, blue: 0.726, alpha: 1),
                                                 downColor: UIColor(red: 0.963, green: 0.814, blue: 0.286, alpha: 1), image: UIImage(), title: "Sport", isLocked: true)
        ]))
    }
